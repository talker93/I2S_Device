...
#define CS2100_REGWRITE(reg, val)                                 \
    {                                                             \
        result = i2c_reg_write(CS2100_I2C_DEVICE_ADDR, reg, val); \
    }
#define CS2100_REGREAD_ASSERT(reg, data, expected)                   \
    {                                                                \
        data[0] = i2c_reg_read(CS2100_I2C_DEVICE_ADDR, reg, result); \
